                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <ul>
                                        ...
                                        <li><a href="" class="popup-video"><i class="fa-solid fa-couch"></i>Ghế {{ $value->ten_ghe }}</a> <span class="duration"><i class="fa-solid fa-money-bill"></i> 45.000 đ</span></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <button class="btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    ...
                                    {{-- <span class="video-count">{{ number_format($tongVe * 45, 0, '.', ',') }}  vnđ</span> --}}
                                    <span class="video-count">{{ number_format($tongVe * 45000, 0, '.', ',') }} vnđ</span>
                                </button>
                                <button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <span class="season">Thanh Toán Ngân Hàng AGRIBANK</span>
                                    <span class="video-count">Bạn cần thanh toán {{ number_format($tongVe * 45000, 0, '.', ',') }} vnđ<br>Qua số tài khoản 5204205317278. <br>Nội dung là {{ $maGiaoDich }}</span>
                                </button>
                                <button class="btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
